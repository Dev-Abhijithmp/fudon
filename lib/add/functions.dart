...
Future<Map<String, String>> donatefood(
  String donatorname,
  String foodtype,
  String foodCount,
    ...
    await FirebaseStorage.instance
        .ref('requestimages/' +
            (FirebaseAuth.instance.currentUser!.uid +
                documentSnapshot.get('requests').toString()))
        .putFile(images);
...
Future<void> changestatus(String donid, String status) async {
  await FirebaseFirestore.instance
      .collection('donations')
      .doc(donid)
